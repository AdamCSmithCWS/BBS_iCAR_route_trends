...
// covariate effect on intercepts and slopes
  sdcov ~ std_normal();//variance of GAM parameters
  ...
  sdbeta_space ~ gamma(2,2);//~ normal(0,0.05); //boundary avoiding prior on sd of slope spatial variation w mean = 0.1 and 99% < 0.33
